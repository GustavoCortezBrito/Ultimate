  ...
  head: () => ({
    meta: [
      { title: "Ultimate Fitness | Mini Bike e Bicicleta Spinning para Casa" },
      {
        name: "description",
        content:
          "Mini bike ergométrica e bicicleta spinning Ultimate Fitness para treino em casa. Envio Full e compra protegida pelo Mercado Livre.",
      },
      { property: "og:title", content: "Ultimate Fitness | Mini Bike e Bicicleta Spinning para Casa" },
      {
        property: "og:description",
        content:
          "Mini bike ergométrica e bicicleta spinning Ultimate Fitness para treino em casa. Envio Full pelo Mercado Livre.",
      },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://ultimate-home-fitness.lovable.app/" },
    ],
    links: [{ rel: "canonical", href: "https://ultimate-home-fitness.lovable.app/" }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          legalName: "ULTIMATE POWER DO BRASIL LTDA",
          taxID: "57.491.644/0001-47",
          url: "https://ultimate-home-fitness.lovable.app/",
          logo: "https://ultimate-home-fitness.lovable.app/logo.png",
          description:
            "Comércio varejista de artigos esportivos e equipamentos fitness para exercícios em casa.",
          address: {
            "@type": "PostalAddress",
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Mini bike ergométrica compacta, portátil e dobrável para exercícios em casa. Possui tela LCD.",
      ...
      },
      {
        ...
        children: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Product",
          name: "Bicicleta Spinning Ultimate Fitness",
          description:
            "Bicicleta ergométrica spinning residencial para cardio em casa, com guidão ajustável e estrutura robusta.",
          brand: { "@type": "Brand", name: "Ultimate Fitness" },
          aggregateRating: { "@type": "AggregateRating", ratingValue: "4.8", reviewCount: "2000" },
          offers: {
            "@type": "Offer",
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              >
                <div className="relative w-full max-w-[500px] aspect-square rounded-3xl overflow-hidden border border-white/10 shadow-2xl group">
                  <img
                    src={heroImg}
                    alt="Bicicleta Spinning Ultimate Fitness e Embalagem Oficial"
      ...
      <footer id="contato" className="bg-[#111113] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div className="space-y-5">
              ...
              <div className="flex gap-3 pt-1">
                {[
                  ...
                  {
                    label: "WhatsApp", href: `https://wa.me/5548XXXXXXXX`,
                ...
                {[
                  ...
                  >
                    <a href={link.href} className="text-gray-400 hover:text-[#FF5722] transition-colors text-sm font-medium flex items-center gap-2">
                      <span className="w-1.5 h-1.5 bg-[#D11919] rounded-full shrink-0" />
                      {link.label}
                    </a>
                  </motion.li>
                ))}
            ...
            {/* Col 3: Products / Pages */}
            <div className="space-y-4">
              <h4 className="text-white font-bold text-sm uppercase tracking-wider">Produtos</h4>
              <ul className="space-y-2.5">
                {[
                  { label: "Mini Bike Ergométrica", to: "/mini-bike-ergometrica" as const },
                  { label: "Bicicleta Spinning", to: "/bicicleta-ergometrica-spinning" as const },
                  { label: "Mercado Livre Full", to: "/mercado-livre-full" as const },
                  { label: "Política de Privacidade", to: "/politica-de-privacidade" as const },
                  { label: "Termos de Serviço", to: "/termos-de-servico" as const },
                ].map((link, i) => (
                  <motion.li
                    key={link.label}
                    initial={{ opacity: 0, x: -16 }}
                    ...
                    transition={{ delay: 0.05 * i }}
                  >
                    <Link to={link.to} className="text-gray-400 hover:text-[#FF5722] transition-colors text-sm font-medium flex items-center gap-2">
                      <span className="w-1.5 h-1.5 bg-[#D11919] rounded-full shrink-0" />
                      {link.label}
                    </Link>
                  </motion.li>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-4">
                ...
                >
                  ...
                  <a href="https://wa.me/5548XXXXXXXX" className="hover:text-[#FF5722] transition-colors">
                    WhatsApp (clique para chamar)
                  </a>
                </motion.li>
                <motion.li
                  initial={{ opacity: 0, y: 8 }}
                ...
                >
                  <Truck size={18} className="text-[#00a650] shrink-0" />
                  <span className="text-sm text-gray-400 font-medium">Logística Mercado Livre Full</span>
                </motion.li>
              </ul>
            </div>
          ...
          >
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="flex gap-6 text-xs">
                <Link to="/politica-de-privacidade" className="text-gray-500 hover:text-[#FF5722] transition-colors font-medium">
                  Política de Privacidade
                </Link>
                <Link to="/termos-de-servico" className="text-gray-500 hover:text-[#FF5722] transition-colors font-medium">
                  Termos de Serviço
                </Link>
              </div>
            </div>
